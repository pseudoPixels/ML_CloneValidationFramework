...
class Utils:
    ...
    def get_clone_pairs(self, cloneIndex, cloneFile):
        ...
        fragment_1_code = self.read_file_in_line_range(CLONE_HOME_DIR + fragment_1_file, int(fragment_1_strt), int(fragment_1_end))
        fragment_2_code = self.read_file_in_line_range(CLONE_HOME_DIR + fragment_2_file, int(fragment_2_strt), int(fragment_2_end))
